...
export const PROPOSALS: Proposal[] = [
	// ── Агроіндустрія ──
	{
		...
		fullDescription:
			'Повноцінна веб-платформа для моніторингу сільськогосподарських угідь із інтеграцією GPS-трекінгу техніки, аналізом якості ґрунтів та прогнозуванням врожайності на основі історичних даних.',
		...
		team: [
			{
				...
				role: 'Full-stack',
			}, // назва файлу з папки public/images/team/
			{
				name: 'Вальцер Вадим',
	...
	},
	{
		...
		fullDescription:
			'B2B маркетплейс для фермерів та закупівельників з системою аукціонів, логістичними інтеграціями та безпечними онлайн-оплатами.',
		category: 'Агроіндустрія',
	...
	// ── Медицина ──
	{
		...
		fullDescription:
			'Система онлайн-запису для клінік з електронними картками пацієнтів, нагадуваннями про візити через SMS/email та інтеграцією з лабораторними системами.',
		category: 'Медицина',
	...
	},
	{
		...
		fullDescription:
			'Агрегатор аптек із зручним пошуком медикаментів, порівнянням цін, інформацією про наявність та можливістю бронювання ліків онлайн.',
		category: 'Медицина',
	...
	// ── Заклади ──
	{
		...
		fullDescription:
			'Повнофункціональна система для закладів харчування: цифрове меню з фото, онлайн-замовлення, інтеграція з кухонним дисплеєм та системою доставки.',
		category: 'Заклади',
	...
	},
	{
		...
		fullDescription:
			'Сервіс бронювання столиків для ресторанів та кафе із інтерактивною схемою залу, передзамовленням страв та автоматичним підтвердженням.',
		category: 'Заклади',
	...
	// ── Мистецтво ──
	{
		...
		fullDescription:
			'Віртуальна галерея із 3D-оглядом робіт, можливістю покупки, портфоліо митців та інтеграцією з соціальними мережами.',
		category: 'Мистецтво',
	...
	},
	{
		...
		fullDescription:
			'Платформа для організації та просування культурних подій: виставок, концертів, вистав. Онлайн-продаж квитків та інтерактивна карта локацій.',
		category: 'Мистецтво',
	...
	// ── Автомобілі ──
	{
		...
		fullDescription:
			'Комплексна платформа для автосервісів: онлайн-запис, CRM для клієнтів, відстеження процесу ремонту та інтеграція з каталогом запчастин.',
		category: 'Автомобілі',
	...
	},
	{
		...
		fullDescription:
			'Маркетплейс для пошуку автозапчастин за VIN-кодом або моделлю авто. Порівняння цін, рейтинги постачальників та доставка по Україні.',
		category: 'Автомобілі',
	...
	// ── Мода та одяг ──
	{
		...
		fullDescription:
			'Сучасний інтернет-магазин одягу із розумною системою рекомендацій, таблицею розмірів, фото 360° та інтеграцією з платіжними системами.',
	...
	},
	{
		...
		fullDescription:
			'Платформа для українських дизайнерів з можливістю створення портфоліо, продажу колекцій та взаємодії з покупцями та байерами.',
		category: 'Мода та одяг',
	...
	// ── Туризм ──
	{
		...
		fullDescription:
			"Туристичний портал з каталогом турів, онлайн-бронюванням, інтерактивною картою пам'яток та відгуками відвідувачів.",
		category: 'Туризм',
	...
	},
	{
		...
		fullDescription:
			'PWA-додаток для туристів з аудіогідом, AR-навігацією по історичних місцях, офлайн-картами та рекомендаціями найкращих закладів.',
		category: 'Туризм',
	...
	// ── Спорт ──
	{
		...
		fullDescription:
			'Комплексна система для фітнес-клубів: управління абонементами, розклад тренувань, профілі тренерів, онлайн-запис на заняття та аналітика відвідувань.',
		category: 'Спорт',
	...
	},
	{
		...
		fullDescription:
			'Портал спортивного життя міста: новини, розклад змагань, таблиці рейтингів, профілі спортсменів та онлайн-трансляції подій.',
		category: 'Спорт',
	...
	// ── Освіта ──
	{
		...
		fullDescription:
			'Платформа дистанційного навчання з відеокурсами, інтерактивними тестами, системою оцінювання та сертифікатами по завершенню.',
		category: 'Освіта',
	...
	},
	{
		...
		fullDescription:
			'Шкільний портал з електронним щоденником, розкладом занять, домашніми завданнями, чатом між вчителями та батьками та онлайн-оплатою послуг.',
		category: 'Освіта',
