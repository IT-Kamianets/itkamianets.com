...
export class News {
	...
	readonly newsItems: NewsItem[] = [
		{
			...
			excerpt: 'Ми відкриваємо нову хвилю набору для студентів та початківців у сфері веб-розробки. Долучайтесь до нашої команди та здобувайте реальний досвід роботи з комерційними проєктами.',
		...
		},
		{
			...
			excerpt: 'Наша команда завершила роботу над трьома новими веб-сайтами, створеними з використанням Tailwind CSS. Кожен проєкт демонструє сучасний підхід до дизайну та розробки.',
		...
		},
		{
			...
			excerpt: 'Від першої консультації до фінального запуску — дізнайтесь, як працює наша команда і чому клієнти обирають IT-Kamianets для реалізації своїх ідей.',
		...
		},
		{
			...
			excerpt: 'Зібрались разом, обговорили досягнення минулого місяця, нові цілі та плани щодо розширення нашого впливу в регіоні.',
		...
		},
		{
			...
			excerpt: 'Чашки, футболки та стікери з логотипом IT-Kamianets — тепер ви можете підтримати нашу спільноту та виглядати стильно.',
		...
		},
		{
			...
			excerpt: 'Angular, Tailwind, SSR, AI-інтеграції та доступність — розглядаємо ключові тренди, які визначатимуть веб у цьому році.',
		...
		},
		{
			...
			excerpt: 'Ми провели перший внутрішній хакатон, де розробники змагались у створенні MVP за 24 години. Результати вразили всіх — три проєкти вже готуються до запуску.',
		...
		},
		{
			...
			excerpt: 'Ми мігрували всі наші проєкти на Angular 21. Сигнали, нові контрольні потоки та покращений SSR — ділимось досвідом та результатами.',
		...
		},
		{
			...
			excerpt: 'Порівнюємо utility-first підхід з класичними CSS-методологіями. Результати продуктивності та швидкості розробки вас здивують.',
		...
		},
		{
			...
			excerpt: 'Наша команда взяла участь у найбільшій веб-конференції України. Доповіді, нетворкінг та нові партнерства — розповідаємо подробиці.',
		...
		},
		{
			...
			excerpt: 'Успішно завершили та впровадили GPS-систему моніторингу полів для одного з найбільших агропідприємств Хмельницької області.',
		...
		},
		{
			...
			excerpt: 'Tailwind vs Bootstrap vs Bulma — детальний аналіз переваг, недоліків та найкращих сценаріїв використання кожного фреймворку.',
	...
	getCategoryLabel(cat: string): string {
		switch (cat) {
			...
			case 'updates': return 'Оновлення';
			case 'articles': return 'Стаття';
			default: return cat;
		}
	}
}
